  ...
  return (
    <div className="product-card">
      ...
      <div className="card-bot">
        ...
        {cardData.styleData.sale_price ?
          <div className="sale-price-container">
            <section className="body-text sale-price">{cardData.styleData.sale_price} USD</section>
            <section className="body-text original-price">{cardData.styleData.original_price} USD</section>
          </div> :
          <section className="body-text price">{cardData.styleData.original_price} USD</section>
        }
